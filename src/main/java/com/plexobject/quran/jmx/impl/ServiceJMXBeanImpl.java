package com.plexobject.quran.jmx.impl;
...
import com.plexobject.quran.jmx.ServiceJMXBean;
import com.plexobject.quran.metrics.Metric;
import com.plexobject.quran.utils.TimeUtils;
...
public class ServiceJMXBeanImpl extends NotificationBroadcasterSupport
    ...
    @Override
    public double getAverageElapsedTimeInMilliSecs() {
        return Metric.getMetric(getServiceName())
                .getAverageDurationInMilliSecs();
    }
    ...
    public long getTotalDurationInMilliSecs() {
        return Metric.getMetric(getServiceName()).getTotalDurationInMilliSecs();
    }
